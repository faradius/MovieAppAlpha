...
import com.alex.movieapp.databinding.UpcomingMovieRowBinding
import com.alex.movieapp.ui.movie.adapters.MovieAdapter

class UpcomingMovieConcatAdapter (private val movieAdapter: MovieAdapter): RecyclerView.Adapter<BaseConcatHolder<*>>() {
